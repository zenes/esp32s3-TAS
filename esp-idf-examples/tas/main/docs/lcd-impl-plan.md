...
| GPIO | SPI 모드 | 8-bit 병렬 | **16-bit (EVB)** | 스트래핑? | 비고 |
|:---:|---|---|---|:---:|---|
| IO1 | TFT_MISO | TFT_D0 | **TFT_D15 (LCD D17)** | — | 모드별 독점 |
| IO2 | TFT_SCLK | TFT_D1 | **TFT_D14 (LCD D16)** | — | 모드별 독점 |
| **IO3** | **TFT_MOSI** | — | **TFT_RST** | **⚠️ YES** | LilyGO 공식 지정 |
| IO4 | TFT_CS | TFT_D2 | **TFT_RD** | — | 모드별 독점 |
| IO8 | TFT_DC | TFT_D3 | **TFT_D6 (LCD D7)** | — | 모드별 독점 |
| IO9 | — | — | **TFT_DC (CMD/DATA)** | — | Command/Data |
| IO10 | — | — | **TFT_D0 (LCD D1)** | — | EVB 전용 |
| IO11 | — | — | **TFT_D1 (LCD D2)** | — | EVB 전용 |
| IO12 | — | — | **TFT_D2 (LCD D3)** | — | EVB 전용 |
| IO13 | — | — | **TFT_D3 (LCD D4)** | — | EVB 전용 |
| IO14 | — | — | **TFT_D4 (LCD D5)** | — | EVB 전용 |
| IO15 | TFT_RST | TFT_D4 | — | — | T-ETH 전용 |
| IO16 | TFT_BL | TFT_D5 | — | — | T-ETH 전용 |
| IO17 | — | TFT_D6 | **TFT_WR (CLK)** | — | Write Clock |
| IO18 | — | TFT_D7 | **TFT_D7 (LCD D8)** | — | 공용 병렬 |
| IO21 | — | TFT_CS | **TFT_D5 (LCD D6)** | — | 공용 병렬 |
| IO38 | — | TFT_DC | **TFT_D9 (LCD D11)** | — | 공용 병렬 |
| IO39 | — | TFT_RST | **TFT_D10 (LCD D12)** | — | 공용 병렬 |
| IO40 | — | TFT_WR | **TFT_D11 (LCD D13)** | — | 공용 병렬 |
| IO41 | — | TFT_RD | **TFT_D12 (LCD D14)** | — | 공용 병렬 |
| IO42 | — | — | **TFT_D13 (LCD D15)** | — | EVB 전용 |
| **IO45** | — | — | **TFT_D8 (LCD D10)** | **⚠️ YES** | EVB 전용 |
| **IO46** | — | — | **TFT_CS** | **⚠️ YES** | EVB 전용 |
| IO47 | — | TFT_BL | — | — | T-ETH 전용 |

> **[IMPORTANT]** 각 환경(SPI, 8-bit, 16-bit)은 핀 맵이 서로 겹치므로 **동시 활성화가 불가능**합니다.
