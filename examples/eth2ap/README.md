...
PlatformIO를 사용하는 경우:
```bash
# platformio.ini에서 src_dir = examples/eth2ap 설정
pio run -e T-ETH-Lite-ESP32S3 -t upload
```

Arduino IDE를 사용하는 경우:
1. `examples/eth2ap/eth2ap.ino` 파일 열기
...
- 원본 ESP-IDF 예제: [esp-idf/examples/ethernet/eth2ap](https://github.com/espressif/esp-idf)
