...
> **[NOTE]** `lcd.md` 최종 권장 기준: 16-bit RGB는 핀 부족(20핀 필요, 여유 18핀)으로 **하드웨어 불가**. 따라서 **SPI**와 **8-bit 병렬** 2가지 인터페이스만 구현합니다.
...
**[MODIFY]** `examples/eth2ap/utilities.h` — `LILYGO_T_ETH_LITE_ESP32S3` 섹션에 추가
